...
/**
 * ListenerRegistry manages the registration and unregistration of event
 * listeners and their handlers. It stores handlers mapped by event type and
 * ensures handlers are sorted by priority.
 */
