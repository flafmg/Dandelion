...
/**
 * Converts an FShort value (fixed-point, where each unit is 1/32) to a conventional Float.
 *
...
/**
 * Converts a conventional Float to FShort (fixed-point, where each unit is 1/32).
 *
